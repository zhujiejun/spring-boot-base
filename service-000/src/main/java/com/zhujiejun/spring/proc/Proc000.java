...
public class Proc000 implements BeanFactoryPostProcessor {
    ...
    public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
        ...
        //Hello h = beanFactory.getBean("com.zhujiejun.spring.bean.Hello", Hello.class);//TODO
        //log.warn("----------1.invoked beanFactoryPostProcess: the bean hello in current IOC container is {}.----------", h.toString());
    }
}
